              ...
              >
                <div className='section-head style-1 text-white'>
                  ...
                  <h2 className='title m-b30'>
                    Subscribe To Our Newsletter For Latest Update Of Our
                    Services{' '}
                  </h2>
                  <p>
                    Want to be the first informed about the latest news and
                    discounts? Subscribe Now!
                  </p>
                </div>
                ...
                <div className='section-wraper-one'>
                  <div className='icon-bx-wraper style-2 left m-b30'>
                    ...
                    <div className='icon-content'>
                      ...
                      <p>
                        We provide innovative ideas for standing out and analyze
                        the requirements to determine the best course of action.
                      </p>
                    </div>
                  </div>
                  <div className='icon-bx-wraper style-2 left m-b30'>
                    ...
                    <div className='icon-content'>
                      ...
                      <p>
                        With code, make stunning and professional designs a
                        reality.
                      </p>
                    </div>
                  </div>
                  <div className='icon-bx-wraper style-2 left m-b30'>
                    ...
                    <div className='icon-content'>
                      ...
                      <p>
                        To get the best results, we conduct sophisticated
                        testing using real-world test cases and deploy them to
