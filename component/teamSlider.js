    ...
    <>
      ...
      >
        ...
        >
          <div className='dlab-team style-1 m-b10'>
            <div className='dlab-media'>
              <img src='images/team/memoji1.png' alt='' />
            </div>
            <div className='dlab-content'>
              <div className='clearfix'>
                <h4 className='dlab-name'>
                  <a href='/team-1'>Sahil </a>
                </h4>
                <span className='dlab-position'>Founder</span>
              </div>
        ...
        >
          <div className='dlab-team style-1 m-b10'>
            <div className='dlab-media'>
              <img src='images/team/memoji2.png' alt='' />
            </div>
            <div className='dlab-content'>
              <div className='clearfix'>
                <h4 className='dlab-name'>
                  <a href='/team-1'>Ashish </a>
                </h4>
        ...
        >
          <div className='dlab-team style-1 m-b10'>
            <div className='dlab-media'>
              <img src='images/team/memoji3.png' alt='' />
            </div>
            <div className='dlab-content'>
              <div className='clearfix'>
                <h4 className='dlab-name'>
                  <a href='/team-1'>Simranjeet</a>
                </h4>
                <span className='dlab-position'>Co-founder</span>
              </div>
              <ul className='dlab-social-icon primary-light'>
